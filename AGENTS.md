...
6. The local Vite showcase runs on `http://localhost:5173`. It now doubles as an original, local-only marketing prototype. Do not publish or deploy it without Justin explicitly asking.
